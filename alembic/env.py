...
# Alembic usará la URL definida en el archivo .env.
...
# Alembic inspeccionará los modelos registrados en Base.metadata.
...
def run_migrations_online() -> None:
    """Ejecuta migraciones conectándose a PostgreSQL."""
